...
public class MajorServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			InputStream input = this.getClass().getResourceAsStream("/school.xml");
			...
			Element proEle = (Element) doc.selectSingleNode("//academy[@name='" + pname + "']");
