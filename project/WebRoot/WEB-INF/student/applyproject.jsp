  ...
  <div class="body-content">
    <form method="post" class="form-x" action="<%= basePath%>studentgoto/applyprojectsubmit.action">
      ...
      <div class="form-group">
        ...
        <div class="field">
           <input id="tnmuber" type="text" class="input w50"   value="" placeholder="请输入指导老师教工号..." data-validate="required:请输入指导老师教工号..."/>
           <input id="tname" class="input w50" style="margin-left: 50px;" placeholder="老师姓名">
      ...
      <div class="form-group">
        ...
        <div class="field">
           <input id="stu1" type="text" class="stu input w50" name="stu1" value="" placeholder="请输入指导学生学号..." data-validate="required:请输入指导学生学号..."/>
      ...
      <div class="form-group">
        ...
        <div class="field">
           <input id="stu2" type="text"  class="stu input w50" name="stu2" value="" placeholder="请输入指导学生学号..." data-validate="required:请输入指导学生学号..."/>
      ...
      <div class="form-group">
        ...
        <div class="field">
           <input id="stu3" type="text" class="stu input w50" name="stu3" value="" placeholder="请输入指导学生学号..." data-validate="required:请输入指导学生学号..."/>
      ...
      <div class="form-group">
        ...
        <div class="field">
           <input id="stu4" type="text" class="stu input w50" name="stu4" value="" placeholder="请输入指导学生学号..." data-validate="required:请输入指导学生学号..."/>
      ...
      <div class="form-group">
        ...
        <div class="field">
           <input id="stu5" type="text" class="stu input w50" name="stu5" value="" placeholder="请输入指导学生学号..." data-validate="required:请输入指导学生学号..."/>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="pname" value="" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
           <input type="text" class="input" name="technology" value=""  placeholder="请输入项目涉及技术领域..." data-validate="required:请输入项目涉及技术领域..."/>
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
           <input type="number" class="input w50" name="officecost" value="" placeholder="请输入办公用品费用..." data-validate="required:请输入办公用品费用..."/>
           <input  class="input w50" style="margin-left: 50px;" name="officemark" placeholder="备注...">
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
           <input type="number" class="input w50" name="materialcost" value="" placeholder="请输入实验材料费用..." data-validate="required:请输入实验材料费用..."/>
           <input  class="input w50" style="margin-left: 50px;" name="materialmark" placeholder="备注...">
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
           <input type="number" class="input w50" name="bookcost" value="" placeholder="请输入书籍资料费用..." data-validate="required:请输入书籍资料费用..."/>
           <input  class="input w50" name="bookmark"  style="margin-left: 50px;" placeholder="备注...">
          <div class="tips"></div>
        </div>
      </div>
        ...
        <div class="field">
           <input type="number" class="input w50" name="postcost" value="" placeholder="请输入邮费费用..." data-validate="required:请输入邮费费用..."/>
           <input  class="input w50" name="postmark" style="margin-left: 50px;" placeholder="备注...">
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
           <input type="number" class="input w50" name="phonecost" value="" placeholder="请输入电话费用..." data-validate="required:请输入电话费用..."/>
           <input  class="input w50" name="phonemark" style="margin-left: 50px;" placeholder="备注...">
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
           <input type="number" class="input w50" name="transportationcost" value="" placeholder="请输入交通费用..." data-validate="required:请输入交通费用..."/>
           <input  class="input w50" name="transportationmark" style="margin-left: 50px;" placeholder="备注...">
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
           <input type="number" class="input w50" name="maintaincost" value="" placeholder="请输入维修费用..." data-validate="required:请输入维修费用..."/>
           <input  class="input w50" name="maintainmark" style="margin-left: 50px;" placeholder="备注...">
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="number" class="input w50" name="printcost" value="" placeholder="请输入印刷费用..." data-validate="required:请输入印刷费用..."/>
           <input  class="input w50" name="printmark" style="margin-left: 50px;" placeholder="备注...">
          <div class="tips"></div>
        </div>
      </div>
