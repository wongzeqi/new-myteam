...
<link rel="stylesheet" href="<%=mypath %>css/about.css">
<style>
.page { width:100%;background:#F0F0F0 url('<%=mypath %>img/dian2.png') repeat-x; }
</style>
...
<div class="box">
	...
	<ul class="event_list">
		...
		<li><span>11月26日</span><p>文字信息29</span></p></li>
		</div>
...
<script src="<%=mypath %>js/jquery-1.4.4.min.js" type="text/javascript"></script>
<script>
$(function(){
